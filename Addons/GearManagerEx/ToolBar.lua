...
local function CreateToolButton(id)
    local button = CreateFrame("Button", frame:GetName().."Button"..id, frame, "SecureActionButtonTemplate,BackdropTemplate")
    button:SetID(id)
...
local checkFrame = CreateFrame("Frame", "GearManagerExToolBarCheckFrame", PaperDollFrame.EquipmentManagerPane, "BackdropTemplate")
