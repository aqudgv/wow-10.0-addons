...
local PVP_CURRENCY_IDS = {
    CURRENCY_IDS_BY_NAME.PVP_HORNOR,
    CURRENCY_IDS_BY_NAME.PVP_CONQUER,
...
local MISCELLANEOUS_CURRENCY_IDS = {
    CURRENCY_IDS_BY_NAME.MINGSHANG_9_0,
    CURRENCY_IDS_BY_NAME.XINNENG_9_0,
    CURRENCY_IDS_BY_NAME.HUIJIN_9_0,
	CURRENCY_IDS_BY_NAME.ANCIENT_MANA,
	CURRENCY_IDS_BY_NAME.ARGENT_COMMENDATION,
