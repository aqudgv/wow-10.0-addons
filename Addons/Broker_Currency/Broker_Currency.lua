		...
		if currencyList then
			for index = 1, #ORDERED_CURRENCY_IDS do
				...
				if displayIcon then
					...
					if count > 0 and char_db[key] then
						local totalMax = CURRENCY_MAX_COUNT[currencyID] or 0
--						if totalMax then
...
--						else
                            ...
                            if totalMax and totalMax > 0 and (currencyID == CURRENCY_IDS_BY_NAME.PVP_CONQUER or currencyID == CURRENCY_IDS_BY_NAME.VALOR) then
