...
local function hook_ContainerFrameItemButton_OnModifiedClick(self, button)
    ...
    for i=1, NUM_CONTAINER_FRAMES do
        for j=1, MAX_CONTAINER_ITEMS do
            ...
            if(f) then
                ...
                hooksecurefunc(f, "OnModifiedClick", hook_ContainerFrameItemButton_OnModifiedClick)
            end
        end
    end
    hooksecurefunc(ContainerFrameItemButtonMixin, "OnModifiedClick", hook_ContainerFrameItemButton_OnModifiedClick) --for later created.
...
local function SetTradeSkillFilter()
    ...
    if slot and TradeFrame:IsVisible() and (TradeSkillFrame and TradeSkillFrame:IsVisible() and not C_TradeSkillUI.IsTradeSkillGuild() and C_TradeSkillUI.GetTradeSkillLine() == GetSpellInfo(7411)) then
