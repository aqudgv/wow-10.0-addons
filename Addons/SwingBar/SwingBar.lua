...
local function CreateUI()
    local f = WW:Frame("SwingBar", UIParent):Size(180,18):BOTTOM("PlayerCastingBarFrame","TOP",0,"20"):Backdrop([[Interface\GLUES\COMMON\Glue-Tooltip-Background]], [[Interface\GLUES\COMMON\TextPanel-Border]], 12, 2)
