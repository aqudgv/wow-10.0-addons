...
function EventAlert_Buffs_Update(...)
	...
	for i=1,40 do
		...
		if (ifAdd_buffCur) then
			...
			EA_SPELLINFO_SELF[spellID]=EA_SPELLINFO_SELF[spellID] or {}
...
function EAFun_CreateVersionFrame_ScrollEditBox()
	...
	if panel3 == nil then
		panel3 = CreateFrame("ScrollFrame", "EA_Version_ScrollFrame", EA_Version_Frame, "UIPanelScrollFrameTemplate,BackdropTemplate");
	end
	local scc = _G["EA_Version_ScrollFrame_List"];
	if scc == nil then
		scc = CreateFrame("Frame", "EA_Version_ScrollFrame_List", panel3, "BackdropTemplate");
	...
	if etb1 == nil then
		etb1 = CreateFrame("EditBox", "EA_Version_ScrollFrame_EditBox", scc, "BackdropTemplate");
...
function EAFun_AddSpellToScrollFrame(spellID, OtherMessage)
	...
	if EA_ShowScrollSpells[spellID] == nil then
		...
		if f1 == nil then
			...
			local ShowScrollIcon = CreateFrame("Frame", "EA_Version_ScrollFrame_Icon_"..spellID, EA_Version_ScrollFrame_List, "BackdropTemplate");
		...
		if f2 == nil then
			local ShowScrollEditBox = CreateFrame("EditBox", "EA_Version_ScrollFrame_EditBox_"..spellID, EA_Version_ScrollFrame_List, "BackdropTemplate");
