...
CoreOnEvent("PLAYER_LOGIN", function()
    ...
    btn:SetScript("OnClick", function()
        ...
        TutorialU1Frame_SetTutorial({
            ...
            [203] = {
                tileHeight = 25,
                text = "注意，启用插件后，默认的大地图将被五星任务采集的无级缩放卫星地图|cffffd200替换|r，但您随时可以按|cffffd200ALT+M|r打开默认的地图界面。在选项中也可以设置为不替换默认大地图。五星任务插件占用较大，但网易有爱特别提供了|cffffd200即时开关|r的功能，只要点击信息条上的\124TInterface\\Icons\\ACHIEVEMENT_GUILDPERK_MRPOPULARITY_RANK2:0\124t按钮（或是在控制台中开关），就可以完全不占用任何CPU，所以您在打副本时轻轻一点，就不会带来卡顿。需要做任务或采集时，再点一下，就可以开启使用。",
                title = "可接任务功能说明",
