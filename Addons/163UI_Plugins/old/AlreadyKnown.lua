...
local CONSUMABLE = GetItemClassInfo(LE_ITEM_CLASS_CONSUMABLE or Enum.ItemClass.Consumable)
local GLYPH = GetItemClassInfo(LE_ITEM_CLASS_GLYPH or Enum.ItemClass.Glyph)
local RECIPE = GetItemClassInfo(LE_ITEM_CLASS_RECIPE or Enum.ItemClass.Recipe)
local MISCALLANEOUS = GetItemClassInfo(LE_ITEM_CLASS_MISCELLANEOUS or Enum.ItemClass.Miscellaneous)
