...
function ToyPlus:CreateFrame()
	...
	toyFrame:SetScript("OnMouseUp", function(self, button)
		if button == "RightButton" then InterfaceOptionsFrame_OpenToCategory(L"ToyPlus") end
	end)
	toyFrame:Show()
	...
	local searchBox = CreateFrame("EditBox", "ToyPlus_Popout_SearchBox", btnPopout, "SearchBoxTemplate")
	searchBox:EnableMouse(true)
	searchBox:SetAutoFocus(false)
	searchBox:SetFontObject("ChatFontSmall")
	searchBox:SetMaxLetters(20)
