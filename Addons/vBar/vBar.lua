   ...
   setmetatable(
      {  },
      {
         ...
         __newindex = function(t, key, val)
            if _G[key] ~= nil then
               _G[key] = val;
               print("\124cff00ff00>\124r vBar: ", key, val)
            else
               rawset(t, key, val);
            end
         end
...
local ActionButton_GetPagedID = ActionButton_GetPagedID or ActionBarActionButtonMixin.GetPagedID;
local ActionButton_UpdateFlash = ActionButton_UpdateFlash or ActionBarActionButtonMixin.UpdateFlash;
...
function _G.VB_DoLoad(self)
   ...
   if ActionBarActionButtonMixin ~= nil then
      for i = 1, 12 do
         hooksecurefunc(_G["ActionButton"..i], "UpdateHotkeys", VB_UpdateHotkeys)
         hooksecurefunc(_G["MultiBarBottomLeftButton"..i], "UpdateHotkeys", VB_UpdateHotkeys)
         hooksecurefunc(_G["MultiBarBottomRightButton"..i], "UpdateHotkeys", VB_UpdateHotkeys)
         hooksecurefunc(_G["MultiBarLeftButton"..i], "UpdateHotkeys", VB_UpdateHotkeys)
         hooksecurefunc(_G["MultiBarRightButton"..i], "UpdateHotkeys", VB_UpdateHotkeys)
      end
      hooksecurefunc(ActionBarActionButtonMixin, "UpdateHotkeys", VB_UpdateHotkeys)
...
----------------------------------------------------------------------------------------------------
function _G.VB_DoEvent(self, event, arg1)
...
function VB_CreateNumpad(shape, ddt, dft, dst)
   ...
   local numpad = CreateFrame('Frame', 'NumpadFrame', UIParent, "BackdropTemplate")
