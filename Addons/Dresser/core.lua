...
if WOW_PROJECT_ID == WOW_PROJECT_MAINLINE then
	...
	DressUpFrame.LinkButton:SetWidth(100);
	local function resize()
		if GetCVar(DressUpFrame.MaxMinButtonFrame.cvar) == "0" then
			DressUpFrameCancelButton:SetWidth(60);
			DressUpFrameResetButton:SetWidth(60);
		else
			DressUpFrameCancelButton:SetWidth(40);
			DressUpFrameResetButton:SetWidth(40);
		end
	end
	hooksecurefunc(DressUpFrame, "SetSize", function()
		C_Timer.After(0.01, resize);
	end);
	resize();
end
