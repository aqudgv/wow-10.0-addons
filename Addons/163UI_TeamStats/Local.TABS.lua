...
--abyuiPW
local tip = "副本评分(最高层数), 绿色层数表示限时, 灰色为超时"
table.insert(TABS, {
    tab = DUNGEON_SCORE, --"史诗钥石赛季评分",
    special = "season_mythic",
    specialIDs = { 391, 392, 370, 369, 166, 169, 234, 227, },
    widths = { 58, 58, 58, 58, 58, 58, 58, 58, },
    tips = { tip, tip, tip, tip, tip, tip, tip, tip, },
    names = { "天街", "宏图", "车间", "垃圾场", "车站",  "码头", "卡上", "卡下", },
})
...
table.insert(TABS, {
    ...
    names = { "典狱", "希瓦", "大帝", "恩佐", "艾萨", "乌纳", "珍娜", "戈霍", "阿古", "基丹", "古尔", "海拉", "萨维", "阿克", "黑手", "悬槌", "小吼", "莱登", "雷神", "永春", "恐心", "魔古" },
})
