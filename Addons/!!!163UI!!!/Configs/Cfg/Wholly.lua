...
U1RegisterAddon("Grail-NPCs", { load = "DEMAND", protected = 1, hide = 1, })
U1RegisterAddon("Grail-NPCs-enUS", { title = "NPC名称本地化-英文", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-NPCs-zhCN", { title = "NPC名称本地化-简中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-NPCs-zhTW", { title = "NPC名称本地化-繁中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-Quests", { load = "DEMAND", protected = 1, hide = 1, })
U1RegisterAddon("Grail-Quests-enUS", { title = "任务名称本地化-英文", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-Quests-zhCN", { title = "任务名称本地化-简中", load = "DEMAND", defaultEnable = 1, })
U1RegisterAddon("Grail-Quests-zhTW", { title = "任务名称本地化-繁中", load = "DEMAND", defaultEnable = 1, })
