...
U1RegisterAddon("PlexusStatusRD_SL", {title = "暗影国度", protected = nil, hide = nil, load="NORMAL", parent="PlexusStatusRaidDebuff", });
U1RegisterAddon("PlexusStatusRD_BfA", {title = "争霸艾泽拉斯", protected = nil, hide = nil, load="NORMAL", parent="PlexusStatusRaidDebuff", });
