...
function ClassModConfigFunc()
	...
	if IsConfigurableAddOn("BFClassMods") or (IsConfigurableAddOn("AttackTimer") and playerclass == "WARRIOR" or playerclass == "PALADIN" or playerclass == "MONK" or playerclass == "DEATHKNIGHT") or (IsConfigurableAddOn("NewPowerBar") and playerclass == "HUNTER" or playerclass == "WARRIOR" or playerclass == "DRUID" or playerclass == "MONK") or playerclass == "ROGUE" then
	...
	if ( (playerclass == "WARRIOR" and IsConfigurableAddOn("AttackTimer")) or (playerclass == "PALADIN" and IsConfigurableAddOn("AttackTimer")) or (playerclass == "MONK" and IsConfigurableAddOn("AttackTimer")) or (playerclass == "DEATHKNIGHT" and IsConfigurableAddOn("AttackTimer")) ) then
		ModManagement_RegisterCheckBox(
			"BigFootClassMod",
			ENABLE_ATTACK_TIMER,
