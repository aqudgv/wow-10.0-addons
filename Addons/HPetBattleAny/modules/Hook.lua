...
--[[	function]] if HPetBattleAny.CreateLinkByInfo then
	--hook原始创建链接函数
...
--[[	init	]] hookPetJournal.init = function()
	--------------- 宠物删除界面优化
...
--petbattle
--[[	Hook	]] hookfunction.PetBattleUnitTooltip_UpdateForUnit = function(self, petOwner, petIndex)
